...
export const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    category: "Enterprise",
    summary:
      "Developing internal web platforms and automation services that support the Autodesk Fusion CI team in managing large-scale multi-platform build infrastructure.",
    impacts: [
      "Build full-stack internal applications and dashboards that give the CI team visibility and control over complex build workflows.",
      "Develop TypeScript & Node.js automation services integrated with cloud CI/CD infrastructure.",
      "Collaborate with infrastructure and C++ engineers to streamline developer feedback loops.",
    ],
    skills: [
      "TypeScript",
      "Node.js",
